    ...
    return (
      ...
      >
        <View style={[styles.statusBanner, { backgroundColor: "#F4433615" }]}>
          ...
          <Text style={[styles.statusBannerText, { color: "#F44336" }]}>
    ...
    return (
      ...
      >
        <View style={[styles.statusBanner, { backgroundColor: theme.card }]}>
          ...
          <Text style={[styles.statusBannerText, { color: theme.text + "40" }]}>
            Turno già completato
          </Text>
        </View>
      </View>
    );
      ...
      <View style={styles.actionRow}>
        <Pressable
          style={({ pressed }) => [
            ...
            { borderColor: theme.text, opacity: isBusy || pressed ? 0.5 : 1 },
          ]}
        ...
        >
          {processing === "accepted" ? (
            ...
            <Text
              style={[styles.buttonTextPrimary, { color: theme.background }]}
            >
              Accetta Candidato
            </Text>
          )}
